...
<p>The Xapian project is based upon the code of Omsee (also known as Open
Muscat) originally developed and released under the GPL by BrightStation PLC.
BrightStation is no longer trading, but some of the original developers from
BrightStation and others from the Omsee community decided to continue
development of the code.  Before the name Xapian was chosen, the project was
briefly known as Omseek.</p>

<p>BrightStation's Omsee project was to be a replacement for their Muscat 3.6
library, which was originally written by Dr. Martin Porter at Cambridge
...
<p>Omsee (using the muscat36 backend) was the retrieval engine which powered
