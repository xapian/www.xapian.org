...
The latest release version is 0.5.2.  There are 3 tarballs (xapian-examples
and omega haven't changed since 0.5.1 so we've not uploaded just to bump
the version):

<ul>
<li> <A HREF="http://www.tartarus.org/~olly/xapian-0.5.2/xapian-core-0.5.2.tar.gz">xapian-core</A>: the Xapian library itself
